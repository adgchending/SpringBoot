...
// * @类描述:消息队列,需要启动F:\RJ\activemq\apache-activemq-5.15.3\bin\win64下的activemq.bat(消息队列服务器) 消息队列服务器:http://localhost:8161/admin/queues.jsp
// * <p>
// * 消息生产者
// * @创建日期: 2022/2/25
// * @修改记录: <pre>
...
//        jmsMessagingTemplate.convertAndSend(queue, "消息" + uuid);
//        System.out.println("消息" + uuid);
//    }
//
//}
//

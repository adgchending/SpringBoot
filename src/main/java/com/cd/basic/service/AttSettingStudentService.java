...
public interface AttSettingStudentService{
	/**
	 ...
	 * @return
	 */
    int updateAttSettingStudent(AttSettingStudent value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttSettingStudent(AttSettingStudent value, Assist assist);
}
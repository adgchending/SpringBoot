...
public interface AttRCardWorkerService{
	/**
	 ...
	 * @return
	 */
    int updateAttRCardWorker(AttRCardWorker value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttRCardWorker(AttRCardWorker value, Assist assist);
}
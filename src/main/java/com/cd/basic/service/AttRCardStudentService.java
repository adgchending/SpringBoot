...
public interface AttRCardStudentService{
	/**
	 ...
	 * @return
	 */
    int updateAttRCardStudent(AttRCardStudent value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttRCardStudent(AttRCardStudent value, Assist assist);
}
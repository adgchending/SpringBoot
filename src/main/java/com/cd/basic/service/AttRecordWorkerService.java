...
public interface AttRecordWorkerService{
	/**
	 ...
	 * @return
	 */
    int updateAttRecordWorker(AttRecordWorker value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttRecordWorker(AttRecordWorker value, Assist assist);
}
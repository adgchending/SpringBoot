...
public interface AttWorkerCardService{
	/**
	 ...
	 * @return
	 */
    int updateAttWorkerCard(AttWorkerCard value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttWorkerCard(AttWorkerCard value, Assist assist);
}
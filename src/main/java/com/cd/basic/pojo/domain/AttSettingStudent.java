...
public class AttSettingStudent {
    private Long id;//主键ID
    private java.util.Date offWprkTime;//放学时间
    ...
    private java.util.Date toWorkTime;//上学时间

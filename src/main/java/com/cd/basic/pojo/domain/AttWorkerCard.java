...
public class AttWorkerCard {
    ...
    private Integer type;//校卡类型：1，考勤卡
    public AttWorkerCard() {
        super();
    }
    public AttWorkerCard(Long id,Long campusFkCode,String cardCode,Integer bindingStatus,Integer delStatus,Integer enableStatus,String remarks,java.util.Date createTime,java.util.Date updateTime,Long fkCode,Long schoolFkCode,Integer type) {
        super();
        this.id = id;

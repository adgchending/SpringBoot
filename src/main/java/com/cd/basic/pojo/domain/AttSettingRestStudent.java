...
public class AttSettingRestStudent {
    private Long id;//主键ID
    private Long settingFkCode;//考勤设置(Att_Setting_Student)外键唯一标识
    ...
    public AttSettingRestStudent() {
        super();
    }
    public AttSettingRestStudent(Long id,Long settingFkCode,Integer delStatus,java.util.Date createTime,java.util.Date updateTime,java.util.Date restBigTime,java.util.Date restEndTime,Long fkCode) {
        super();
        this.id = id;

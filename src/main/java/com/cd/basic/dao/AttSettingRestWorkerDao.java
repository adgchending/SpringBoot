...
@Mapper
public interface AttSettingRestWorkerDao {
    /**
    ...
    /**
     * 批量插入AttSettingRestWorker到数据库,包括null值
     *
     * @param value
     * @return
     */
     ...
     * @return
     */
    int updateAttSettingRestWorker(@Param("enti") AttSettingRestWorker value, @Param("assist") Assist assist);
     ...
     * @return
     */
    int updateNonEmptyAttSettingRestWorker(@Param("enti") AttSettingRestWorker value, @Param("assist") Assist assist);
}

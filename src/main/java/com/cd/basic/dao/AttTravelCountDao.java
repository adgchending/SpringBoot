...
@Mapper
public interface AttTravelCountDao{
	/**
	...
	/**
	 * 批量插入AttTravelCount到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateAttTravelCount(@Param("enti") AttTravelCount value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttTravelCount(@Param("enti") AttTravelCount value, @Param("assist") Assist assist);
}

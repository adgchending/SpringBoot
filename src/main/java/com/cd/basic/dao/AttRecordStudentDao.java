...
@Mapper
public interface AttRecordStudentDao{
	/**
	...
	/**
	 * 批量插入AttRecordStudent到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateAttRecordStudent(@Param("enti") AttRecordStudent value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttRecordStudent(@Param("enti") AttRecordStudent value, @Param("assist") Assist assist);
}

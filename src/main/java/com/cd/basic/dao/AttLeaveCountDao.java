...
@Mapper
public interface AttLeaveCountDao{
	/**
	 ...
	 * @return
	 */
    int updateAttLeaveCount(@Param("enti") AttLeaveCount value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttLeaveCount(@Param("enti") AttLeaveCount value, @Param("assist") Assist assist);
}

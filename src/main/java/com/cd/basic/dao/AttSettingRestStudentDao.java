...
@Mapper
public interface AttSettingRestStudentDao{
	/**
	...
	/**
	 * 批量插入AttSettingRestStudent到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateAttSettingRestStudent(@Param("enti") AttSettingRestStudent value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttSettingRestStudent(@Param("enti") AttSettingRestStudent value, @Param("assist") Assist assist);
}

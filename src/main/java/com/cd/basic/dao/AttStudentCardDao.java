...
@Mapper
public interface AttStudentCardDao{
	/**
	...
	/**
	 * 批量插入AttStudentCard到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateAttStudentCard(@Param("enti") AttStudentCard value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyAttStudentCard(@Param("enti") AttStudentCard value, @Param("assist") Assist assist);
}
